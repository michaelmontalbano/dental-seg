...
# Training configuration for length AND diameter regression with company embeddings
hyperparameters = {
    ...
    'task': 'both',  # Predict BOTH length and diameter
    'epochs': 100,
    'batch_size': 32,
...
print("🎯 Length & Diameter Regression with Company Embeddings - SageMaker Training")
print("=" * 60)
print("📊 Architecture highlights:")
print("   • Pretrained company model produces 256-dim embeddings")
print("   • Regression head predicts both length and diameter")
...
estimator = PyTorch(
    ...
    base_job_name='regression-both-embeddings',
    output_path=f's3://{session.default_bucket()}/regression-both-embeddings-output',
