...
class DiameterClassifier(nn.Module):
    def __init__(self, base_model_name, num_classes):
        ...
        print(f"   Diameter bins: {num_classes}")
...
def parse_args():
    parser = argparse.ArgumentParser(description='Train Diameter Classifier')
    ...
    parser.add_argument('--output_dir', type=str, default='outputs_diameter')
...
def main():
    ...
    print("📏 Diameter Classification Training")
    print("=" * 60)
    ...
    model = DiameterClassifier(model_map[args.model_size], num_classes).to(device)
