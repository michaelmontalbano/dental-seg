...
def parse_args():
    ...
    parser.add_argument('--task-name', type=str, default='Dataset303_ClinicalTreatmentPathology',
                        help='Task name (e.g., Task101_DentalCBCT)')
    parser.add_argument('--dataset-id', type=int, default=303,  # Changed from 300
