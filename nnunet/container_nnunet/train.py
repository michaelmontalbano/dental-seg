...
def parse_args():
    ...
    parser.add_argument('--task-name', type=str, default='Dataset304_ToothSurfaces',  # Changed from Dataset300_BoneLoss
                        help='Task name (e.g., Task101_DentalCBCT)')
    parser.add_argument('--dataset-id', type=int, default=304,  # Changed from 300
