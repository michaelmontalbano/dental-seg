...
# Training configuration for diameter classification
hyperparameters = {
    ...
    'save_best_only': 'true',
    'warmup_epochs': 5,
    'bin_size': 0.2  # 0.2mm bins for diameter classification
}

print("📏 Diameter Classification - SageMaker Training Configuration")
print("=" * 50)
...
estimator = PyTorch(
    entry_point='train_diameter_classifier.py',
    source_dir='.',
    role=role,
    ...
    base_job_name='diameter-classifier',
    output_path=f's3://{session.default_bucket()}/diameter-classifier-output',
