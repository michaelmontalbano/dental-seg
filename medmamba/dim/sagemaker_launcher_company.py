...
# Training configuration for company classification
hyperparameters = {
...
print("🏢 Company Classification - SageMaker Training Configuration")
print("=" * 50)
...
estimator = PyTorch(
    entry_point='train_company_classifier.py',
    source_dir='.',
    role=role,
    ...
    base_job_name='company-classifier',
    output_path=f's3://{session.default_bucket()}/company-classifier-output',
