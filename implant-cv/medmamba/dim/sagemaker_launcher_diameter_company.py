...
prefix = "implants/diameter-company-classification"
...
job_name = f"diameter-company-classifier-{timestamp}"

# Create PyTorch estimator
estimator = PyTorch(
    entry_point="train_diameter_with_company.py",
    source_dir=".",
    role=role,
    ...
    base_job_name="diameter-company-classifier"
)
