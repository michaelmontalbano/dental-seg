...
class LengthClassifier(nn.Module):
    def __init__(self, base_model_name, num_classes):
        ...
        print(f"   Length bins: {num_classes}")
...
def parse_args():
    parser = argparse.ArgumentParser(description='Train Length Classifier')
    ...
    parser.add_argument('--output_dir', type=str, default='outputs_length')
...
def main():
    ...
    print("📐 Length Classification Training")
    print("=" * 60)
    ...
    model = LengthClassifier(model_map[args.model_size], num_classes).to(device)
