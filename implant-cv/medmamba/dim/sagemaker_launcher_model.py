...
# Training configuration for model classification
hyperparameters = {
...
print("🔧 Model Classification - SageMaker Training Configuration")
print("=" * 50)
...
estimator = PyTorch(
    entry_point='train_model_classifier.py',
    source_dir='.',
    role=role,
    ...
    base_job_name='model-classifier',
    output_path=f's3://{session.default_bucket()}/model-classifier-output',
